...
public class FeedActivity extends AppCompatActivity {
    ...
    @Override
    public boolean onCreateOptionsMenu(Menu menu) {//hangi menu baglanacak
    ...
    @Override
    public boolean onOptionsItemSelected(MenuItem item) {//menudeki itemlara tıklanırsa
        if (item.getItemId() == R.id.add_post) {
        ...
        else if(item.getItemId()==R.id.slider){
            ...
            Intent intent = new Intent(getApplicationContext(),FoodPictures.class);
            startActivity(intent);
        }
