...
public class PostClass extends ArrayAdapter<String> {
    ...
    public PostClass(ArrayList<String> username, ArrayList<String> userComment, ArrayList<Bitmap> userImage, Activity context) {
        super(context,R.layout.custom_view,username);//PostClass extends ArrayAdapter<String>arrayadapter yazdıgımız için herhangi bir array dizisi ile bağlamak yeterli-->username
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        View customView = layoutInflater.inflate(R.layout.custom_view,null,true); //custom_view i objelestırmekıcın yapıyoru
